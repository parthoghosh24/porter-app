package com.partho.porter.porterdelivery.utils.ui;
...
public class FontAwesomeDrawable extends Drawable {
    ...
    public FontAwesomeDrawable(int icon, int sizeDpi, int color,
        ...
        Typeface font = Typeface.createFromAsset(context.getAssets(), "fonts/fa.ttf");
    ...
    public static class FontAwesomeDrawableBuilder {
        ...
        public FontAwesomeDrawableBuilder(Context context, int icon) {
            this.context = context;
            this.icon = icon;
        }
        ...
        public FontAwesomeDrawable build() {
